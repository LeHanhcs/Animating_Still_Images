////////////////////////////////////////////////////////////////////////////////////////////////////
/// File:	sharedmatting.cpp.
///
/// Summary:	Implements the sharedmatting class.
////////////////////////////////////////////////////////////////////////////////////////////////////
...
void SharedMatting::SetImage(cv::Mat org)
{
	pImg = org.clone();
	if (!pImg.data)
	{
...
void SharedMatting::SetTrimap(cv::Mat inTrimap)
{
	trimap = inTrimap.clone();
	if (!trimap.data)
	{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::comalpha(Scalar c, Scalar f, Scalar b)
///
/// Summary:	Comalphas.
///
/// Author:	Yc Lin
...
///
/// Parameters:
/// c - 	   	A Scalar to process. 
/// f - 	   	A Scalar to process. 
/// b - 	   	A Scalar to process. 
///
/// Returns:	A double.
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::mP(int i, int j, Scalar f, Scalar b)
///
/// Summary:	M p.
///
/// Author:	Yc Lin
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::nP(int i, int j, Scalar f, Scalar b)
///
/// Summary:	N p.
///
/// Author:	Yc Lin
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::pfP(Point p, vector<Point>& f, vector<Point>& b)
///
/// Summary:	Pf p.
///
/// Author:	Yc Lin
...
///
/// Parameters:
/// p - 	   	A Point to process. 
/// f - 	   	[in,out] A vector&lt;Point&gt; to process. 
/// b - 	   	[in,out] A vector&lt;Point&gt; to process. 
///
/// Returns:	A double.
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::aP(int i, int j, double pf, Scalar f, Scalar b)
///
/// Summary:	A p.
///
/// Author:	Yc Lin
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::dP(Point s, Point d)
///
/// Summary:	D p.
///
/// Author:	Yc Lin
...
///
/// Parameters:
/// s - 	   	A Point to process. 
/// d - 	   	A Point to process. 
///
/// Returns:	A double.
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::gP(Point p, Point fp, Point bp, double pf)
///
/// Summary:	G p.
///
/// Author:	Yc Lin
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::gP(Point p, Point fp, Point bp, double dpf, double pf)
///
/// Summary:	G p.
///
/// Author:	Yc Lin
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::sigma2(Point p)
///
/// Summary:	Sigma 2.
///
/// Author:	Yc Lin
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	double SharedMatting::distanceColor2(Scalar cs1, Scalar cs2)
///
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	void SharedMatting::sample(Point p, std::vector<Point> &f, std::vector<Point> &b)
///
/// Summary:	Samples.
///
/// Author:	Yc Lin
...
/// Parameters:
/// p - 	   	A Point to process. 
/// f - 	   	[in,out] A std::vector&lt;Point&gt; to process. 
/// b - 	   	[in,out] A std::vector&lt;Point&gt; to process. 
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Fn:	void SharedMatting::Sample(std::vector<vector<Point> > &F, std::vector<vector<Point> > &B)
///
/// Summary:	Samples.
///
/// Author:	Yc Lin
...
///
/// Parameters:
/// F - 	   	[in,out] A std::vector&lt;vector&lt;Point&gt;&gt; to process. 
/// B - 	   	[in,out] A std::vector&lt;vector&lt;Point&gt;&gt; to process. 
////////////////////////////////////////////////////////////////////////////////////////////////////
...
cv::Mat SharedMatting::GetResult(){
	return matte.clone();
}
